...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">    
    <div class="wrapper-page">
        ...
        <div class="form-horizontal m-t-20">
            ...
            <asp:Label CssClass="alert alert-danger alert-dismissable" runat="server" ID="ErrorMessage" Visible="false" style="color: #ef5350;background-color:none !important;border:none !important;" />
            <br/><br/>
