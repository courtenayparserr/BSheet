...
{
    public partial class DashboardCopy : BasePage
    {
        ...
        public string GetUpDown(double amount)
        {
            ...
            return
                "<div class=\"trend\"><i class=\"fa fa-caret-" + upDown + "\" aria-hidden=\"true\"></i>" + String.Format("{0:C}", Math.Abs(Convert.ToDouble(amount))).TrimEnd(')').TrimStart('(') + "</div>";
