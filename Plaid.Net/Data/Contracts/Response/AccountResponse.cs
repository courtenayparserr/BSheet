namespace Plaid.Net.Contracts
{
    ...
    internal class AccountResponse
    {
        ...
        public Account ToAccount()
        {
            ...
            if (this.Balance.Available.HasValue)
                account.AvailableBalance = this.Balance.Available.Value;
            if (this.Balance.Current.HasValue)
                account.CurrentBalance = this.Balance.Current.Value;
            account.Id = this.Id;
